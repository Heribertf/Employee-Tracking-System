...
<body>
 	<form action="ProjectAllocationServlet" method="post">
    <h1 align="center">Assign Project</h1>
    <h1>
      <a href="viewProjectAssign.jsp">List Project Allocations</a>
    </h1>
    <table border="1" align="center" cellpadding="5"
      ...
      <tr>
        ...
        <td><input type="date" name="allocatedFrom"></td>
      </tr>
      <tr>
        <td>Allocated To</td>
        <td><input type="date" name="allocatedTo"></td>
      </tr>
      <tr>
        <td>Reporting Manager EmailId</td>
        <td><input type="text" name="reportingManagerEmailId"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td></td>
        <td><input type="submit" name="Action" value="Assign Project"></td>
      </tr>
    </table>
  </form>
</body>
