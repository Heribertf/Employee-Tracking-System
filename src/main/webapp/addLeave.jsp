...
<body>
    ...
    <h1>
     <!-- <a href="viewLeave.jsp">List Leaves</a>-->
    </h1>
    <table border="1" align="center" cellpadding="5"
      ...
      <tr>
        <td>Taken From</td>
        <td><input type="date" name="takenFrom"></td>
      </tr>
      <tr>
        <td>Taken To</td>
        <td><input type="date" name="takenTo"></td>
      </tr>
      <tr>
        <td>Status</td>
        <td>
      ...
      <tr>
        <td></td>
        <td><input type="submit" name="Action" value="Request Leave"></td>
      </tr>
    </table>
  </form>
</body>
