...
<body>
    ...
    <div>
        <ul>
            ...
            <li><a href="updateAllocation.jsp">Update Allocation</a></li>
            <li><a href="addProject.jsp">Add Project</a></li>
            <li><a href="add.jsp">Add User</a></li>
            <li><a href="edit.jsp">Update User</a></li>
            <li><a href="delete.jsp">Delete User</a></li>
            <li><a href="editProject.jsp">Update Project</a></li>
            <li><a href="addLeave.jsp">Add Leave</a></li>
            ...
            <li><a href="viewProjectAssign.jsp">View Allocations</a></li>
    ...
    <div class="hero-image">
        <div>
          <h1 style="font-size:50px" class="hero-text">Welcome Admin to Employee Tracking Performance System</h1>
