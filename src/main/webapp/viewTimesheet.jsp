...
<body>
  <form action="">
    ...
    <h2 align="center">
      <a href="addTimesheet.jsp">Add New Timesheet</a><br>
    </h2>

    <h1 align="center">List of Timesheets</h1>
    <table border="1" align="center" cellpadding="5"
      ...
      <%
        ...
        ResultSet resultSet = statement.executeQuery("Select * from timesheet");
      ...
      <tr>
        ...
        <form action="TimesheetServlet" method="post">
          <td><a value="Update" name="Action"
            href="updateTimesheet.jsp?id=<%=resultSet.getInt(1)%> ">Update</a> <input
