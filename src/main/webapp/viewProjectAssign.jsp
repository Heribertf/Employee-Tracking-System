...
<body>
  <form action="">
    ...
    <h2 align="center">
      <a href="assignProject.jsp">Assign New Project</a><br>
    </h2>

    <h1 align="center">List of Project Allocations</h1>
    <table border="1" align="center" cellpadding="5"
      ...
      <%
        ...
        ResultSet resultSet = statement.executeQuery("Select * from project_allocation");
      ...
      <tr>
        ...
        <form action="ProjectAllocationServlet" method="post">
          <td><a value="Update" name="Action"
            href="updateAllocation.jsp?id=<%=resultSet.getInt(1)%> ">Update</a> <input
